...
class EtxtAntiPlagiat {
    ...
    execRequest() {
        ...
        curlTest.setOpt(
            ...
            `xmlUrl=${this.localServer}/tasks&xmlAnswerUrl=${this.localServer}upload.php`
        );
        curlTest.setOpt(Curl.option.TRANSFERTEXT, 1);
        curlTest.setOpt(Curl.option.TIMEOUT, 5);
        ...
        curlTest.on('end', (statusCode, data, headers) => {
            ...
            console.log(`xmlUrl=${this.localServer}/tasks&xmlAnswerUrl=${this.localServer}upload.php`);
